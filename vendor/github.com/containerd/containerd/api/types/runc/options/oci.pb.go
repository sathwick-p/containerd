...
type CheckpointOptions struct {
	...
	WorkPath      string `protobuf:"bytes,10,opt,name=work_path,json=workPath,proto3" json:"work_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_oci_proto_rawDesc = "" +
	"\n" +
	"\toci.proto\x12\x12containerd.runc.v1\"\xa6\x03\n" +
	"\aOptions\x12\"\n" +
	...
	"\x10task_api_version\x18\r \x01(\rR\x0etaskApiVersionJ\x04\b\b\x10\t\"\xe7\x02\n" +
	...
	"\fcgroups_mode\x18\b \x01(\tR\vcgroupsMode\x12\x1d\n" +
	"\n" +
	"image_path\x18\t \x01(\tR\timagePath\x12\x1b\n" +
	"\twork_path\x18\n" +
	" \x01(\tR\bworkPath\")\n" +
